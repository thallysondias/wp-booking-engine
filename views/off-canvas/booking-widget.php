...
<div id="omnibees-off-canvas">
  <div id="be-off-canvas" class="promolateral">  
        ...
        <form action="<?php echo $actionBe ?>" method="GET" target="_blank" class="motor-reserva-v1" id="form-booking">
              ...
              if ($can_foreach) {
                ...
                if (count($selectedHotel) > 1){
                  ...
                  <div class="hotel input-container">
                    <label for="q">
                      <img class="input-image" src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/hotel-outlined.svg' ?>">
                    </label>
          ...
          <div class="guests">
            <div class="adulto input-container">
              <label for="ad">
                <img class="input-image" src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/guest-outline.svg' ?>">
              </label>
							<div class="select-wrapper">
            ...
            <div class="crianca input-container">
              <label for="ch">
                <img class="input-image" src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/child-outline.svg' ?>">
              </label>
							<div class="select-wrapper">
          ...
          <div class="codigo input-container">
            <label for="Code">
              <img class="input-image" src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/cupom-outlined.svg' ?>">
            </label>
    ...
    <a href="https://www.omnibees.com" target="_blank">
			<img id="by-omnibees-logo" src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/by-omnibees.svg' ?>">
		</a>
  </div>
  <div id="main-button">
	<?php	
      ...
      <h5 class="h5reservar"><?php echo "$booknow" ;?></h5>
		...
		<div id="button-reserva-flutuante"  class="btn-reservar ">
			<div class="btn-circle">
				<div class="text-book-now"><?php echo "$booknow" ;?></div>
				<div class="icon-btn">
					<img src="<?php echo $url . '/plugins/wp-booking-engine-master/views/off-canvas/img/calendar_add_on.svg' ?>">
				</div>
			</div>
		</div>
